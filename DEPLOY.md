...
- ⚠️ **DeployBox chạy code của người dùng** (build + container). An toàn khi **chỉ team tin cậy** dùng. Trước khi mở cho người ngoài (SaaS) cần **cô lập** (gVisor/Firecracker, resource limit) — xem Phase 3 trong `docs/09-bao-mat-va-rui-ro.md`.
